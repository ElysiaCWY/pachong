...
XAMZFGJJ_INDEX = "https://www.xamzfgjj.cn/zxwj/index.jhtml"
...
def _page_url(page_no: int) -> str:
    if page_no <= 1:
        return XAMZFGJJ_INDEX
    return f"https://www.xamzfgjj.cn/zxwj/index_{page_no - 1}.jhtml"
...
def crawl_xamzfgjj_zxwj(current_time: datetime | None = None, max_pages: int = 3) -> list[dict]:
    """抓取兴安盟住房公积金中心中心文件，仅保留近24小时内条目。"""
    ...
    for page_no in range(1, max_pages + 1):
        ...
        try:
            ...
            print(f"[XAMZFGJJ] fetch failed(page={page_no}): {e}")
            break
