...
SYSGJJ_INDEX = "https://sysgjj.org.cn/zxwj/index.jhtml"
...
def _page_url(page_no: int) -> str:
    if page_no <= 1:
        return SYSGJJ_INDEX
    return f"https://sysgjj.org.cn/zxwj/index_{page_no}.jhtml"
...
def crawl_sysgjj_zxwj(current_time: datetime | None = None, max_pages: int = 3) -> list[dict]:
    """抓取双鸭山市住房公积金管理中心中心文件，仅保留近24小时内发布的标题和链接。"""
    ...
    for page_no in range(1, max_pages + 1):
        ...
        try:
            ...
            print(f"[SYSGJJ] fetch failed(page={page_no}): {e}")
            break
